...
tinyMCE.init({
	...
	plugins : "spellchecker,preview,paste,noneditable,inlinepopups,advimage,advlink",
	convert_urls : false,
	...
	theme_advanced_buttons1 : "bold,italic,underline,separator,undo,redo,separator,link,unlink,autosave,separator,spellchecker,separator,code",
